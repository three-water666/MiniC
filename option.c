...
//             fprintf(fp,"%s[label=\"EXT_DEC_LIST\"]\n",a);
//             // fprintf(fp,"%s->EXT_DEC_LIST\n",fkind);
//             display(T->ptr[0], "EXT_DEC_LIST");     //依次显示全局变量名，
//             display(T->ptr[1], "EXT_DEC_LIST"); //后续还有相同的，仅显示语法树此处理代码可以和类似代码合并
//             break;
//         case FUNC_DEF:
//             // printf("%*c函数定义：\n", indent, ' ');
//             strcpy(a,newNode());
...
//             fprintf(fp,"%s[label=\"FUNC_DEF\"]\n",a);
//             // fprintf(fp,"%s->FUNC_DEF\n",fkind);
//             display(T->ptr[0], "FUNC_DEF"); //显示函数返回类型
//             display(T->ptr[1], "FUNC_DEF"); //显示函数名和参数
...
//                 // printf("%*c函数形参：\n", indent, ' ');
//                 //参数暂时没管
//                 display(T->ptr[0], "FUNC_DEC"); //显示函数参数列表
//             }
//             else
//                 // printf("%*c无参函数\n", indent + 4, ' ');
//             break;
...
//             fprintf(fp,"%s[label=\"PARAM_LIST\"]\n",a);
//             // fprintf(fp,"%s->PARAM_LIST\n",fkind);
//             display(T->ptr[0], "PARAM_LIST"); //依次显示全部参数类型和名称，
//             display(T->ptr[1], "PARAM_LIST");
//             break;
//         case PARAM_DEC:
//             // printf("%*c类型：%s, 参数名：%s\n", indent, ' ',
//             //        T->ptr[0]->type == INT ? "int" : T->ptr[0]->type == FLOAT ? "float"
...
//             // fprintf(fp,"%s->COMP_STM\n",fkind);
//             // printf("%*c复合语句的变量定义：\n", indent + 4, ' ');
//             display(T->ptr[0], "COMP_STM"); //显示定义部分
//             // printf("%*c复合语句的语句部分：\n", indent + 4, ' ');
//             display(T->ptr[1], "COMP_STM"); //显示语句部分
//             break;
//         case STM_LIST:
//             strcpy(a,newNode());
//             fprintf(fp,"%s->%s\n",fkind,a);
//             fprintf(fp,"%s[label=\"STM_LIST\"]\n",a);
//             // fprintf(fp,"%s->STM_LIST\n",fkind);
//             display(T->ptr[0], "STM_LIST"); //显示第一条语句
//             display(T->ptr[1], "STM_LIST"); //显示剩下语句
//             break;
//         case WHILE:
//             // printf("%*cWHILE循环：\n", indent, ' ');
//             strcpy(a,newNode());
...
//             // fprintf(fp,"%s->WHILE\n",fkind);
//             // printf("%*c循环条件：\n", indent + 4, ' ');
//             display(T->ptr[0], "WHILE"); //显示循环条件
//             // printf("%*c循环体：\n", indent + 4, ' ');
//             display(T->ptr[1], "WHILE"); //显示循环体
//             break;
//         case IF_THEN:
//             // printf("%*cIF_THEN型条件语句：\n", indent, ' ');
//             strcpy(a,newNode());
...
//             // fprintf(fp,"%s->IF_THEN\n",fkind);
//             // printf("%*c条件：\n", indent + 4, ' ');
//             display(T->ptr[0], "IF_THEN"); //显示条件
//             // printf("%*cIF子句：\n", indent + 4, ' ');
//             display(T->ptr[1], "IF_THEN"); //显示if子句
//             break;
//         case IF_THEN_ELSE:
//             // printf("%*cIF_THEN_ELSE型条件语句：\n", indent, ' ');
//             strcpy(a,newNode());
...
//             // fprintf(fp,"%s->IF_THEN_ELSE\n",fkind);
//             // printf("%*c条件：\n", indent + 4, ' ');
//             display(T->ptr[0], "IF_THEN_ELSE"); //显示条件
//             // printf("%*cIF子句：\n", indent + 4, ' ');
//             display(T->ptr[1], "IF_THEN_ELSE"); //显示if子句
//             // printf("%*cELSE子句：\n", indent + 4, ' ');
...
//             fprintf(fp,"%s[label=\"DEF_LIST\"]\n",a);
//             // fprintf(fp,"%s->DEF_LIST\n",fkind);
//             display(T->ptr[0], "DEF_LIST"); //显示该局部变量定义列表中的第一个
//             display(T->ptr[1], "DEF_LIST"); //显示其它局部变量定义
//             break;
//         case VAR_DEF:
//             // printf("%*c局部变量：\n", indent, ' ');
//             strcpy(a,newNode());
...
//             fprintf(fp,"%s[label=\"VAR_DEF\"]\n",a);
//             // fprintf(fp,"%s->VAR_DEF\n",fkind);
//             display(T->ptr[0], "VAR_DEF"); //显示变量类型
//             display(T->ptr[1], "VAR_DEF"); //显示该定义的全部变量名
//             break;
//         case DEC_LIST:
//             // printf("%*c表达式：\n", indent, ' ');
//             strcpy(a,newNode());
...
//                     //显示初始化表达式
//                     //此处未完善
//                     display(T0->ptr[0]->ptr[1], "ASSIGNOP");
//                 }
//                 else if (T0->ptr[0]->kind == Array)
//                 {
//                     display(T0->ptr[0], "DEC_LIST");
//                 }
//                 T0 = T0->ptr[1];
//             }
//             break;
...
//             fprintf(fp,"%s[label=\"%s\"]\n",a,T->type_id);
//             // fprintf(fp,"%s->%s\n",fkind,T->type_id);
//             display(T->ptr[0], T->type_id);
//             display(T->ptr[1], T->type_id);
//             break;
//         case NOT:
//         case UMINUS:
//             // printf("%*c%s\n", indent, ' ', T->type_id);
...
//         case EXT_DEF_LIST:
//             strcpy(a,newNode);
//             display(T->ptr[0],"EXT_DEF_LIST");
//             display(T->ptr[1], "EXT_DEF_LIST"); //显示该外部定义列表中的其它外部定义
//             break;
//         case EXT_VAR_DEF:
//             // printf("%*c全局变量定义：\n", indent, ' ');
//             fprintf(fp,"%s->EXT_VAR_DEF\n",fkind);
//             display(T->ptr[0], "EXT_VAR_DEF"); //显示全局变量类型
//             display(T->ptr[1], "EXT_VAR_DEF"); //显示全局变量列表
//             break;
//         case TYPE:
//             // printf("%*c类型： %s\n", indent, ' ', T->type_id);
//             fprintf(fp,"%s->TYPE_%s\n",fkind,T->type_id);
//             break;
//         case EXT_DEC_LIST:
//             fprintf(fp,"%s->EXT_DEC_LIST\n",fkind);
//             display(T->ptr[0], "EXT_DEC_LIST");     //依次显示全局变量名，
...
// void display(struct node *T, int indent) //indent控制空格个数生成树形
// {
//     int i = 1;
//     struct node *T0;
//     if (T)
...
//         case EXT_VAR_DEF:
//             printf("%*c全局变量定义：\n", indent, ' ');
//             display(T->ptr[0], indent + 4); //显示全局变量类型
//             // printf("%*c变量名：\n",indent+4,' ');
...
//             display(T->ptr[1], indent + 4); //后续还有相同的，仅显示语法树此处理代码可以和类似代码合并
//             break;
//         case FUNC_DEF:
//             printf("%*c函数定义：\n", indent, ' ');
...
//             {
//                 printf("%*c函数形参：\n", indent, ' ');
//                 display(T->ptr[0], indent + 4); //显示函数参数列表
//             }
//             else
//                 printf("%*c无参函数\n", indent + 4, ' ');
//             break;
...
//             printf("%*c复合语句：\n", indent, ' ');
//             printf("%*c复合语句的变量定义：\n", indent + 4, ' ');
//             display(T->ptr[0], indent + 8); //显示定义部分
//             printf("%*c复合语句的语句部分：\n", indent + 4, ' ');
//             display(T->ptr[1], indent + 8); //显示语句部分
//             break;
//         case STM_LIST:
...
//             printf("%*cWHILE循环：\n", indent, ' ');
//             printf("%*c循环条件：\n", indent + 4, ' ');
//             display(T->ptr[0], indent + 8); //显示循环条件
//             printf("%*c循环体：\n", indent + 4, ' ');
//             display(T->ptr[1], indent + 8); //显示循环体
//             break;
//         case IF_THEN:
//             printf("%*cIF_THEN型条件语句：\n", indent, ' ');
//             printf("%*c条件：\n", indent + 4, ' ');
//             display(T->ptr[0], indent + 8); //显示条件
//             printf("%*cIF子句：\n", indent + 4, ' ');
//             display(T->ptr[1], indent + 8); //显示if子句
//             break;
//         case IF_THEN_ELSE:
//             printf("%*cIF_THEN_ELSE型条件语句：\n", indent, ' ');
//             printf("%*c条件：\n", indent + 4, ' ');
...
//             display(T->ptr[1], indent + 8); //显示if子句
//             printf("%*cELSE子句：\n", indent + 4, ' ');
//             display(T->ptr[2], indent + 8); //显示else子句
//             break;
//         case DEF_LIST:
...
//         case VAR_DEF:
//             printf("%*c局部变量：\n", indent, ' ');
//             display(T->ptr[0], indent + 4); //显示变量类型
//             display(T->ptr[1], indent + 4); //显示该定义的全部变量名
//             break;
//         case DEC_LIST:
//             printf("%*c表达式：\n", indent, ' ');
//             T0 = T;
